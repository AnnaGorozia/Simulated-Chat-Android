...
public class DBUserDao extends AbstractDao<DBUser, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Avatar = new Property(3, Blob.class, "avatar", false, "AVATAR");
        public final static Property IsOnline = new Property(4, long.class, "isOnline", false, "IS_ONLINE");
        public final static Property DetailsId = new Property(5, long.class, "detailsId", false, "DETAILS_ID");
    }
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"DBUSER\" (" + //
                ...
                "\"DISPLAY_NAME\" TEXT NOT NULL ," + // 1: email
                "\"PHONE_NUMBER\" TEXT NOT NULL ," + // 2: password
                "\"AVATAR\" BLOB NOT NULL ," + // 2: password
                "\"IS_ONLINE\" INTEGER NOT NULL ," + // 2: password
    ...
    protected void bindValues(SQLiteStatement stmt, DBUser entity) {
        ...
        stmt.bindBlob(4, entity.getAvatar());
        stmt.bindLong(5, entity.getIsOnline());
        stmt.bindLong(6, entity.getDetailsId());
    }
    ...
    public DBUser readEntity(Cursor cursor, int offset) {
        DBUser entity = new DBUser( //
                ...
                cursor.getBlob(offset + 3), // detailsId
                cursor.getLong(offset + 4), // detailsId
                cursor.getLong(offset + 5) // detailsId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, DBUser entity, int offset) {
        ...
        entity.setAvatar(cursor.getBlob(offset + 3));
        entity.setIsOnline(cursor.getLong(offset + 3));
        entity.setDetailsId(cursor.getLong(offset + 4));
    }
